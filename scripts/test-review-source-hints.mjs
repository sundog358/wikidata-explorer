...
import { formatSourceHint, sourceHintKind, sourceHintsFromStatement, sourceHintSummary, sourceHintValueText } from "../lib/review-source-hints.mjs";
...
assert.match(formatSourceHint(hints[0]), /Stated in: stated in \(P248\) = Encyclopaedia Britannica \(Q455\)/);
