...
- `scripts/test-search-fixture-flow.mjs`: route-mocked browser test that serves Wikidata, language, Commons media, no-result, missing-entity, and Wikidata outage fixtures to the live search workbench without external Wikidata calls
