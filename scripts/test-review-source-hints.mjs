...
assert.equal(sourceHintUrl({ property: { id: "P999", data_type: "external-id", formatter_url: "https://example.org/record/{id}" }, value: { content: { value: "Alpha/Beta" } } }), "https://example.org/record/Alpha%2FBeta");
assert.equal(sourceHintUrl({ property: { id: "P999", data_type: "external-id", formatter_url: "https://example.org/lookup/%241" }, value: { content: { value: "A+B" } } }), "https://example.org/lookup/A%2BB");
assert.equal(sourceHintUrl({ property: { id: "P999", data_type: "external-id", formatter_url: "https://example.org/id" }, value: { content: { value: "abc 123" } } }), "https://example.org/id/abc%20123");
assert.equal(sourceHintUrl({ property: { id: "P999", data_type: "external-id", formatter_url: "https://example.org/search?id=" }, value: { content: { value: "abc 123" } } }), "https://example.org/search?id=abc%20123");
