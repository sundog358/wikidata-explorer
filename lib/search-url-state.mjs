...
const EXPORT_VIEWS = new Set(["graph-markdown", "graph-json", "comparison-markdown", "comparison-json", "comparison-property"]);
...
function validComparisonPropertyId(params) {
  const value = params.get("cprop") || "";
  return /^P\d+$/i.test(value) ? value.toUpperCase() : null;
}
...
export function readSearchWorkbenchState(input) {
  ...
  return {
    ...
    comparisonPropertyId: validComparisonPropertyId(params),
...
export function writeSearchWorkbenchState(input, state = {}) {
  ...
  const comparisonPropertyId = Object.prototype.hasOwnProperty.call(state, "comparisonPropertyId") ? state.comparisonPropertyId : current.comparisonPropertyId;
  ...
  setOrDelete(params, "cprop", comparisonPropertyId);
