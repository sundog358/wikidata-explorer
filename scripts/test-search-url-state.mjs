...
const state = readSearchWorkbenchState("?q=Q42&tab=compare&gdepth=property&glayout=timeline&gkind=item&grank=normal&gprop=p31&gevidence=referenced&gfocus=q5");
